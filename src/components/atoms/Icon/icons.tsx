...
export const ThemeLightIcon = ({ size, color }: { size?: number; color?: string }) => (
  <Icon size={size} color={color}>
...
export const ThemeDarkIcon = ({ size, color }: { size?: number; color?: string }) => (
  <Icon size={size} color={color}>
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const LogoutIcon = ({ size, color }: { size?: number; color?: string }) => (
  <Icon size={size} color={color}>
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
